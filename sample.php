...
//$host = 'http://160.86.175.153';
//$host = 'http://sys.kei1.me';


//$host = 'https://taiyokanamono.net';
...
echo "text1 : ";
echo $oneRecords['fieldData']['Text1'];
echo "<br />";
echo "text2 : ";
echo $oneRecords['fieldData']['Text2'];
echo "<br />";
echo "Container : ";
echo $oneRecords['fieldData']['Container'];
echo "<br />";
echo "Global : ";
echo $oneRecords['fieldData']['Global'];
echo "<br />";
echo "<br />";
echo "next recode : ";
echo "<br />";
